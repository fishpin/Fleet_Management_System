...
namespace FleetManagementSystem.Migrations
{
    ...
    [Migration("20260415000004_AddCustomerAddressAndLicense")]
    partial class AddCustomerAddressAndLicense
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Reservation", b =>
                {
                    ...
                    b.Property<bool>("IncludesInsurance").HasColumnType("bit");
            ...
            modelBuilder.Entity("Vehicle", b =>
                {
                    ...
                    b.Property<string>("Make").IsRequired().HasColumnType("nvarchar(max)");
                    b.Property<string>("Model").IsRequired().HasColumnType("nvarchar(max)");
                    b.Property<decimal>("PricePerDay").HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("Billing", b =>
                {
                    b.HasOne("Reservation", "Reservation").WithMany().HasForeignKey("ReservationId").OnDelete(DeleteBehavior.Cascade).IsRequired();
            ...
            modelBuilder.Entity("Reservation", b =>
                {
                    b.HasOne("Customer", "Customer").WithMany().HasForeignKey("CustomerId").OnDelete(DeleteBehavior.Cascade).IsRequired();
